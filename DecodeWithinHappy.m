function DecodeWithinHappy (cfg2, subject)
beta_dir = [cfg2.dataDir, '/emogen', num2str(subject, '%03i'),'/GLM/WithinHappy/'];
...
cfg.results.dir = fullfile('/home/s2229889/emogen/derivatives/preprocessing', ...
    ['emogen', num2str(subject, '%03i')], 'MVPA', 'WithinHappy');
