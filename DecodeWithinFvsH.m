function DecodeWithinFvsH (cfg2, subject)
beta_dir = [cfg2.dataDir, '/emogen', num2str(subject, '%03i'),'/GLM/withinFvsH/'];
...
labelnames = {'Fear', 'Happy'};
contrast_name = 'withinFvsH';
labels = [1 2];
...
cfg.results.dir = fullfile('/home/s2229889/emogen/derivatives/preprocessing', ...
    ['emogen', num2str(subject, '%03i')], 'MVPA', 'withinFvsH');
