...
%% Normalisation Cross Happy
cfg.spmDir = spmDir;
cfg.preprocDir = preprocDir;

cfg.spmDir = fileparts(which('spm'));
mvpa = 'MVPA/CrossHappy'; % Klopt deze map?
...
%% Normalisation Cross Fear
cfg.spmDir = spmDir;
cfg.preprocDir = preprocDir;

cfg.spmDir = fileparts(which('spm'));
mvpa = 'MVPA/CrossFear'; % Klopt deze map?
...
cfg.preprocDir = preprocDir;
cfg.contrastName = 'CrossHappy';
cfg.resultsDir = [preprocDir, '/GroupLevel/CrossHappy'];
...
cfg.subsToDo = subsToDo;
cfg.preprocDir = preprocDir;
cfg.contrastName = 'CrossFear';
cfg.resultsDir = [preprocDir, '/GroupLevel/CrossFear'];
resultsDir = cfg.resultsDir;
groupLevelAnalysis(cfg)