...
for subject = subsToDo
    BuildGLMCrossFrvsHp(cfg, subject)
end

clear cfg

%% Decode across task Fear vs Happy
cfg2.dataDir = preprocDir;
cfg2.spmDir = spmDir;
cfg2.runs = 3;

for subject = subsToDo
    DecodeCrossFvsH(cfg2, subject);
end

clear cfg2

%% Normalisation Cross Fear vs Happy
cfg.spmDir = spmDir;
cfg.preprocDir = preprocDir;

cfg.spmDir = fileparts(which('spm'));
mvpa = 'MVPA/crossFvsH'; % Klopt deze map?
