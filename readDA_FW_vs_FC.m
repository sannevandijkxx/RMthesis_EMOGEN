function [mean_decoding_accuracies] = readDA_FW_vs_FC(cfg)

%% Define decoding analyses (must match your MVPA folder names)
decodingNames = {'CrossFear'};

%% Define ROIs to loop over
roiFilenames = {'RightAntPFC.nii', 'Presuppmot.nii', 'LeftVisualAssoc2.nii','LeftSupramGy.nii','LeftFFA1.nii'};
