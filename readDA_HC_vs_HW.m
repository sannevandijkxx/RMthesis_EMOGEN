function [mean_decoding_accuracies] = readDA_HC_vs_HW(cfg)

%% Define decoding analyses (must match your MVPA folder names)
decodingNames = {'WithinHappy'};

%% Define ROIs to loop over
roiFilenames = {'LeftSecVisual1.nii','RightSecVisual1.nii',...
    'RightFFA.nii','LeftVisualAssoc1.nii', 'LeftSecVisual2.nii'};
