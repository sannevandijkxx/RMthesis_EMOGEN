function DecodeCrossFvsH (cfg2, subject)
%% decoding emotion - cross task
beta_dir = [cfg2.dataDir, '/emogen', num2str(subject, '%03i'), '/GLM/crossFvsH/'];
...
% Define labels
labelnames= {'EmoFear', 'EmoHappy', 'GenderFear', 'GenderHappy'}; 
labels = [1 2 1 2];
xclass = [1 1 2 2];

% Define contrast name for output
contrast_name = 'crossFvsH';
...
cfg.results.dir = fullfile('/home/s2229889/emogen/derivatives/preprocessing', ...
    ['emogen', num2str(subject, '%03i')], 'MVPA', 'crossFvsH');
