function DecodeCrossHappy (cfg2, subject)
...
% Define labels
labelnames= {'EmoHappy', 'EmoNeutral', 'GenderHappy', 'GenderNeutral'}; 
labels = [1 2 1 2];
xclass = [1 1 2 2];

% Define contrast name for output
contrast_name = 'CrossHappy';
...
cfg.results.dir = fullfile('/home/s2229889/emogen/derivatives/preprocessing', ...
    ['emogen', num2str(subject, '%03i')], 'MVPA', 'CrossHappy');
